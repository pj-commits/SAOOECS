<x-app-layout>
    <div class="pt-24">
        <div class="max-w-screen mx-auto px-4 lg:px-8">
            ...
            <x-edit-form-message message="Narrative Report"/>
                    ...
                    <div x-data="comment_suggestion_handler()">
                        ...
                        <div class="grid grid-flow-row auto-rows-max mt-4 md:grid-cols-4">
                            ...
                            <div>
                                ...
                                <x-input x-model="getTotalRating" id="ratings" class="mt-1 w-full" type="number" name="ratings" step=".1" required autofocus/>
