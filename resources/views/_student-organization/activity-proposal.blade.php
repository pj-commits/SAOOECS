<x-app-layout>
    <div class="pt-12" x-data="set_session_storage_data('apf')"> {{-- apf = Activity Proposal Form --}}
        <div class="max-w-screen mx-auto px-4 lg:px-8" x-data="get_session_storage_data('apf')">
            <div class="flex justify-between flex-wrap">
                ...
                <x-button @click="clear_form_session_storage('apf', true), loading(true)">
