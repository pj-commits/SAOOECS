    ...
    <div class="pt-24"> 
        <div class="max-w-screen mx-auto px-4 lg:px-8">
            ...
            <div class="bg-white mt-4 h-auto w-full rounded-sm shadow-sm px-6 py-4">
                ...
                {{-- Row #2 --}}
                <div class="grid grid-flow-row auto-rows-max gap-6 my-4 md:grid-cols-4">
                    <p class="font-bold">Control Number: <span class="font-normal"> {Data Here}</span></p>
                    <p class="font-bold md:col-start-4">Date Needed: <span class="font-normal"> {Data Here}</span></p>
                </div>

                {{-- Row #3 --}}
                <div class="grid grid-flow-row auto-rows-max gap-6 my-4 md:grid-cols-4">
                    <p class="font-bold">Type: <span class="font-normal"> {Data Here}</span></p>
                    <p class="font-bold md:col-start-4">Charged Department: <span class="font-normal"> {Data Here}</span></p>
                </div>
